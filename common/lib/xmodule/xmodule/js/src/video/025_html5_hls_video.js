...
function(VideoJS, VideoJSHLS) {
    ...
    HTML5Video.Player = (function() {
        ...
        Player.prototype.commonSetup = function(el) {
        ...
        function Player(el, config) {
            var sourceList, errorMessage, lastSource;

            _.bindAll(this, 'onLoadedMetadata', 'onPlay', 'onPlaying', 'onPause', 'onEnded', 'commonSetup');
